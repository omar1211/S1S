...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/omar1211/S11")
    AUTONAME = os.environ.get("AUTONAME", "@L_H_V")
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "L_H_V")
    THUMB_IMAGE = os.environ.get("THUMB_IMAGE", "https://telegra.ph/file/6980a6a91fa1e4fc5cd61.jpg")
