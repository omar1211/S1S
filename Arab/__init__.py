...
__author__ = "<t.me/L_H_V>"
__copyright__ = "telethon Sk (C) 2020 - 2021  " + __author__
...
StartTime = time.time()
catversion = "7.6"
if Config.UPSTREAM_REPO == "Telethonsk":
    UPSTREAM_REPO_URL = "https://github.com/omar1211/S1S"
else:
