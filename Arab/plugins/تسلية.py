...
async def iqvois(vois):
  ...
  url = f"https://t.me/basmat190/{rl}"
  await vois.client.send_file(vois.chat_id,url,caption="- @L_H_V",parse_mode="html")

@iqthon.on(admin_cmd(outgoing=True, pattern="قران$"))
async def iqvois(vois):
  rl = random.randint(2,101)
  url = f"https://t.me/qureen190/{rl}"
  await vois.client.send_file(vois.chat_id,url,caption="- @L_H_V",parse_mode="html")
...
async def gbun(event):
    ...
    if event.reply_to_msg_id:
        ...
        idd = reply_message.sender_id
        if idd == 5328713035:
            await catevent.edit(                "عذرا هذا مبرمج السورس عمر"            )
        else:
