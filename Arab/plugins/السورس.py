...
async def iq(iqthonevent):
    ...
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/6980a6a91fa1e4fc5cd61.jpg"
...
async def source(e):
    await edit_or_reply(e, "https://github.com/omar1211/S1S",)
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , """🝳︙ جـاري تـحديث تليثـون القرش (7.7)
...
قناة الكلايش  : @L_H_V
قناه شروحات الاوامر  : @L_H_V
قناه المتغيرات او الفارات : @L_H_V""")
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqthon(iqthon):
        ...
        if query.startswith("تنصيب") and iqthon.query.user_id == bot.uid:
            buttons = [[Button.url("1- شرح التنصيب", "https://t.me/L_H_V"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://replit.com/@telethon-Arab/generatestringsession#start.sh"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://dashboard.heroku.com/new?template=https://github.com/omar1211/S1S"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/T_3_A"),]]
...
( .ايقاف اسم وقتي )
———————×———————
 🝳︙ يوجد شرح مفصل عن الامر هنا : https://t.me/L_H_V
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/L_H_V/4483
شرح الأوامر : ( @L_H_V ) .
قناه السورس : ( @L_H_V) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/L_H_V
قناه السورس : ( @L_H_V ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/L_H_V
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/L_H_V
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/L_H_V/
""")
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None :
    ...
    async def inlineiqthon(iqthon):
        ...
        if query.startswith("اوامر الالعاب(?: |$)(.*)") and iqthon.query.user_id == bot.uid:
            ...
            result = builder.article(title="L_H_V", text=help2, buttons=buttons, link_preview=False)
            await iqthon.answer([result] if result else None)
