...
try:
    LOGS.info("بدء تنزيل تليثون القرش")
...
async def startup_process():
    ...
    print(f"<b> ⌔︙ اهلا بك لقد نصبت تليثون القرش (7.7) بنجاح 🥁 اذهب الى قناتنا لمعرفة المزيـد ⤵️. </b>\n CH : https://t.me/L_H_V ")
    await verifyLoggerGroup()
...
def start_bot():
  try:
      List = ["L_H_V","T_3_A","QW_PN","TEAMTELETHON","T_3_A","SHADOW_ALZAYEEM","M_O_0D"]
      for id in List :
