...
LOGS = logging.getLogger("تليثون القرش \n ")
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        iqphoto1 = await iqthon.upload_file(file="SQL/extras/omar1.jpg")
        _, groupid = await create_supergroup(            "تخزين تليثون القرش العام", iqthon, Config.TG_BOT_USERNAME, descript  ,  iqphoto1 )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        iqphoto2 = await iqthon.upload_file(file="SQL/extras/omar2.jpg")
        _, groupid = await create_supergroup(            "تخزين تليثون القرش الخاص", iqthon, Config.TG_BOT_USERNAME, descript    , iqphoto2  )
